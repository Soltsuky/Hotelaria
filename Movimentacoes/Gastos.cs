...
namespace Hotelaria.Movimentacoes
{
    public partial class FrmGastos : Form
    {
        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            con.AbrirCon();
            sql = "UPDATE gastos SET descricao = @descricao, valor = @valor, funcionario = @funcionario, data = GETDATE() where id = @id";
            cmd = new SqlCommand(sql, con.con);
            cmd.Parameters.AddWithValue("@descricao", txtDescricao.Text);
            cmd.Parameters.AddWithValue("@valor", txtValor.Text.Replace(",", "."));
            cmd.Parameters.AddWithValue("@funcionario", Program.nomeUsuario);
            ...
            con.AbrirCon();
            sql = "UPDATE movimentacoes SET valor = @valor, funcionario = @funcionario, data = GETDATE() where id_movimento = @id and movimento = @movimento";
            cmd = new SqlCommand(sql, con.con);
